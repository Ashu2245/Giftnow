...
import { View, Image, StatusBar, ScrollView, ActivityIndicator } from 'react-native';
  ...
  render() {
    return (
      <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'space-around' }}>
        <StatusBar backgroundColor={HEXCOLOR.CloudBurst} barStyle="light-content" />
        {/* <ScrollView> */}
        ...
        <View style={{ justifyContent: 'space-between' }}>
          <View>
            {this.props.refresh ? <ActivityIndicator animating color={HEXCOLOR.BahamaBlue} size="large" /> :
            <Form>
                <Item floatingLabel >
